...
sudo -u ticketwww sh -c "cd $DATABASE_MIGRATION_SOURCE_DIR && git fetch origin && git checkout -q origin/master"
...
sudo -u ticketwww sh -c "cd $DATABASE_MIGRATION_SOURCE_DIR && git checkout -q -"
